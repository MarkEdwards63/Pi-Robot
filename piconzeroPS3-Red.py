...
# Settings for the joystick - use buttons 5 and 4
...
joystick.init()
jsid=joystick.get_id()
jsname=joystick.get_name()
redjs = "Generic X-Box pad"
bluejs = "Performance Designed Products Wireless Controller for PS3"
print(int(jsid),jsname)
if jsname == redjs:
    print("red")
elif jsname == bluejs:
    print("blue")
