...
mediumspeed = 30   # slow speed for medium turn 15
fastspeed = 40     # slow speed for fast turn   20
speed = 100         # normal speed
rightwheel = 1      # wheel number for setMotor function
leftwheel = 0
frontturndistance = 200     # maze walls are 360 mm apart so aim for middle
