...
leftwheel = 0
frontturndistance = 180     # maze walls are 360 mm apart so aim for middle
...
try:
    ...
    while onRun <= 3:   # run 1 go forward 122 cm and turn right
        ...
        if distanceFront >= 1000: # if distance reading over 1000 mm then discard as greater than distance between walls
    ...
    while onRun <= 7:   # run 4 go forward 72 cm and turn left
        # get new sensor value and add to range to calculate average
